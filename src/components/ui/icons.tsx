...
export function IconFactory({ size = 18, ...props }: IconProps) {
  return (
    <svg {...base(size)} {...props}>
...
export function IconDollar({ size = 18, ...props }: IconProps) {
  return (
    <svg {...base(size)} {...props}>
...
export function IconMaterial({ size = 18, ...props }: IconProps) {
  return (
    <svg {...base(size)} {...props}>
      <path d="M2 2l7.5 7.5" />
      <path d="M2 7.5L9.5 15" />
      <path d="M9.5 2L17 9.5" />
      <path d="M9.5 7.5L17 15" />
...
export function IconSearch2({ size = 18, ...props }: IconProps) {
  return (
    <svg {...base(size)} {...props}>
      <circle cx="11" cy="11" r="8" />
      <line x1="21" y1="21" x2="16.65" y2="16.65" />
