...
const nav: NavItem[] = [
  ...
  { href: "/material-library", label: "Material Library", icon: IconMaterial, roles: ["admin", "pbd", "costing"], section: "Data" },
  { href: "/admin/master-benchmark", label: "Master Benchmark", icon: IconChart, roles: ["admin", "pbd", "costing", "md"], section: "Data" },
